...
googleWorkspaceAuthProvider.addScope("https://www.googleapis.com/auth/forms.body");
googleWorkspaceAuthProvider.addScope("https://www.googleapis.com/auth/forms.responses.readonly");
